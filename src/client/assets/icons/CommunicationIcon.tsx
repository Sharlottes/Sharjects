...
const CommunicationIcon: React.FC<SvgIconProps> = (props) => {
  return (
    <SvgIcon {...props} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 416 416" sx={{ 'enable-background': 'new 0 0 416 416' }} xmlSpace="preserve">
      <g>
