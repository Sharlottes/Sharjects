...
const TagsSelection: React.FC<MotionProps> = ({ ...props }) => {
  ...
  return (
    <motion.div style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }} {...props}>
      {allTags.map((tag, i) =>
...
const ProjectSection: React.FC<BoxProps> = ({ ...props }) => {
  ...
  return (
    <Box {...props}>
      <Typography variant='h2' fontFamily='bold'>Projects</Typography>
      <Typography variant='body2' sx={{ marginTop: '10px', marginBottom: '10px', paddingLeft: '20px' }}>my own projects and teams' one</Typography>
      <Divider />
