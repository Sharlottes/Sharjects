...
export type TimelineNavRefType = { setLatestItem: (item: HTMLDivElement) => void };
export interface TimelineNavProps {
  scroll: (direction: 'up' | 'down') => void
}
const TimelineNav: CustomNextPage<TimelineNavProps, TimelineNavProps, React.ForwardRefExoticComponent<React.PropsWithoutRef<TimelineNavProps> & React.RefAttributes<TimelineNavRefType>>>
  = React.forwardRef<TimelineNavRefType, TimelineNavProps>(({ scroll }, ref) => {
