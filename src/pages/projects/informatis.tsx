...
const AboutPage: React.FC = () => {
    return (
        <>
            <Stack direction='column' sx={{ justfiyContent: 'center', display: 'flex' }}>
                <Typography variant='h1' sx={{ fontWeight: 'bold', display: 'flex', justifyContent: 'center' }}>Informatis</Typography>
                <Typography variant='body1' sx={{ width: '100%', display: 'flex', justifyContent: 'center', textAlign: 'center' }}>
                    Mindustry 플레이에서 더 다양한 정보와 보조 기능을 제공받아보세요!
                    원하는 유닛이나 건물의 상세정보 실시간 조회, 웨이브에 나올 적을 미리 알 수 있는 등 다양한 정보들이 준비되어있습니다!
                </Typography>
            </Stack>
            ...
            <Box sx={{ width: '100%', padding: 2, display: 'flex', justifyContent: 'start' }}>
                ...
                <Typography variant='body2' sx={{ marginLeft: 1, width: '550px' }}>
                    ...
                    일반적으로 알기 힘들거나 알 수 없는 자신 또는 상대의 유닛과 건물 정보를 알기에 적합합니다.
                    <span style={{ fontWeight: 'bold', display: 'block' }}>PvP, 공격맵에서 적의 HP와 재장전을 미리 알고 전략을 짜보세요!</span>
                </Typography>
            </Box>
            ...
            <Box sx={{ width: '100%', padding: 2, display: 'flex', justifyContent: 'start' }}>
                ...
                <Typography variant='body2' sx={{ marginLeft: 1, width: '550px' }}>
                    현재 맵에 설정된 단계 정보를 순서대로 알 수 있는 창UI.
                    일반적으로 절대 알 수 없는 다음 단계 정보를 확인하고 대비하기에 적합합니다.
                    <span style={{ fontWeight: 'bold', display: 'block' }}>다음 단계에 어떤 유닛이 등장하는지 미리 확인하고 대비하세요!</span>
                </Typography>
            </Box>
            <Divider textAlign="left"><Typography variant='h5'>기능 상세정보</Typography></Divider>
            <Grid container
